                    ...
                    <div id="content-wrapper">
                        ...
                        <div id="content">
                            ...
                            <div id="content-inner">
                            	...
                            	?>
                                <form action="/includes/ui/editCategory.php" method="post">
                                    <table>
                                        <tr>
                                            <td><label for="categoryTitle">Title:</label></td>
                                            <td><input type="text" name="categoryTitle" value="<?PHP echo $cat['Title']; ?>"/></td>
                                        </tr>
                                        <tr>
                                            <td><label for="categoryDescription">Description:</label></td>
                                            <td><input type="text" name="categoryDescription" value="<?PHP echo $cat['Description']; ?>"/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><input type="hidden" name="categoryID" value="<?PHP echo $cat['ID']; ?>" /></td>
                                            <td><INPUT Type="button" VALUE="Cancel" onClick="history.go(-1);return true;"><button type="submit" name="Submit" >Submit</button></td>
                                        </tr>                        
                                    </table>
                                </form>
                                <?PHP } ?>
